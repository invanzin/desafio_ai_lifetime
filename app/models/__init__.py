...
- schemas_extract: Schemas do Extractor (ExtractRequest, ExtractedMeeting)
- schemas_analyze: Schemas do Analyzer (AnalyzeRequest, AnalyzedMeeting)
"""
